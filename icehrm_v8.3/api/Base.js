...
IceHRMBase.method('getTableTopButtonHtml', function() {
	...
	if(this.getShowAddNew()){
		html = '<button onclick="modJs.renderForm();return false;" class="btn btn-small btn-primary">Thêm  <i class="fa fa-plus"></i></button>';
	}
	...
	if(this.getFilters() != null){
		...
		html+='<button onclick="modJs.showFilters();return false;" class="btn btn-small btn-primary">Lọc dữ liệu <i class="fa fa-filter"></i></button>';
		html += "&nbsp;&nbsp;";
