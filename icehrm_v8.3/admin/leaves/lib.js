...
EmployeeLeaveAdapter.method('getFormFields', function() {
	return [
	        ...
	        [ "employee", {"label":"Nhân viên","type":"select","allow-null":false,"remote-source":["Employee","id","first_name+last_name"]}],
	        [ "leave_type", {"label":"Loại nghỉ","type":"select","remote-source":["LeaveType","id","name"]}],
	        [ "date_start", {"label":"Ngày bắt đầu","type":"date","validation":""}],
	        [ "date_end", {"label":"Ngày kết thúc","type":"date","validation":""}],
	        [ "details", {"label":"Lý do","type":"textarea","validation":"none"}]
	];
});
...
EmployeeLeaveAdapter.method('getFilters', function() {
	return [
	        [ "employee", {"label":"Nhân viên","type":"select2","allow-null":false,"remote-source":["Employee","id","first_name+last_name"]}],
	        [ "leave_type", {"label":"Loại nghỉ","type":"select","allow-null":true,"null-label":"All Leave Types","remote-source":["LeaveType","id","name"]}]
	];
});
