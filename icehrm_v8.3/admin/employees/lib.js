...
EmployeeAdapter.method('getFormFields', function() {
	return [
			...
			[ "employee_id", {"label":"Mã nhân viên","type":"text","validation":""}],
			 [ "first_name", {"label":"Họ","type":"text","validation":""}],
			 [ "middle_name", {"label":"Tên lót","type":"text","validation":"none"}],
	       [ "last_name", {"label":"Tên","type":"text","validation":""}],
	      [ "nationality", {"label":"Quốc tịch","type":"select2","remote-source":["Nationality","id","name"]}],
	        [ "birthday", {"label":"Ngày sinh","type":"date","validation":""}],
	         [ "gender", {"label":"Giới tính","type":"select","source":[["Male","Male"],["Female","Female"]]}],
	        [ "marital_status", {"label":"Tình trạng hôn nhân ","type":"select","source":[["Married","Married"],["Single","Single"],["Divorced","Divorced"],["Widowed","Widowed"],["Other","Other"]]}],
			...
			[ "address1", {"label":"Địa chỉ 1","type":"text","validation":"none"}],
	        [ "address2", {"label":"Địa chỉ 2","type":"text","validation":"none"}],
	        [ "city", {"label":"Tỉnh","type":"text","validation":"none"}],
	        [ "country", {"label":"Country","type":"select2","remote-source":["Country","code","name"]}],
	       [ "province", {"label":"Tỉnh","type":"select2","allow-null":true,"remote-source":["Province","id","name"]}],
	        [ "postal_code", {"label":"Postal/Zip Code","type":"text","validation":"none"}],
	         [ "home_phone", {"label":"Điện thoại nhà ","type":"text","validation":"none"}],
	        [ "mobile_phone", {"label":"Di động","type":"text","validation":"none"}],
	        [ "work_phone", {"label":"Điện thoại cơ quan","type":"text","validation":"none"}],
	        [ "work_email", {"label":"Work Email","type":"text","validation":"emailOrEmpty"}],
	       [ "private_email", {"label":"Email cá nhân","type":"text","validation":"emailOrEmpty"}],
	        [ "joined_date", {"label":"Ngày vào","type":"date","validation":""}],
